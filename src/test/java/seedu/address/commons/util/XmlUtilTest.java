...
public class XmlUtilTest {
    ...
    private static final File VALID_FILE = new File(TEST_DATA_FOLDER + "validTouristBook.xml");
    private static final File TEMP_FILE = new File(TestUtil.getFilePathInSandboxFolder("tempTouristBook.xml"));
